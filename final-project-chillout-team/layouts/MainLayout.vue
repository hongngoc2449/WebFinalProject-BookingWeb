        ...
        <ul
          ...
          <li @mouseenter="isAccountMenu = true" @mouseleave="isAccountMenu = false"
            ...
            <div id="AccountMenu" v-if="isAccountMenu"
              ...
              <div class="border-b" />
              <ul class="bg-white">
                <li @click="navigateTo('')" class="text-[13px] py-2 px-4 w-full hover:bg-gray-200">Homepage</li>
            ...
            <div class="relative">
              <div class="flex items-center border-2 border-[#FF4646] rounded-md w-full">
                <input class="w-full placeholder-gray-400 text-sm pl-3 focus:outline-none"
                  placeholder="kitchen accessories" type="text" v-model="searchItem" aria-label="Search" />

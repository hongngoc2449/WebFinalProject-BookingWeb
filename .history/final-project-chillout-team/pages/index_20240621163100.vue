<template>
  <div id="MainLayout">
    ...
    <head>
      ...
      <meta name="description" content="Welcome to the Shopping Website. Find the best products here." />
    </head>
    ...
    <header id="MainHeader" class="flex items-center w-full bg-white">
      <div class="flex lg:justify-start justify-between gap-10 max-w-[1150px] w-full px-3 py-5 mx-auto">
        <NuxtLink to="/" class="min-w-[170px]">
          <img width="130" src="/logo.png" alt="Shopping Website Logo" />
        </NuxtLink>
              ...
              <div v-if="false" class="p-1">
                ...
                >
                  <div class="flex items-center">
                    <img class="rounded-md" width="40" src="https://picsum.photos/id/9/300/300" alt="Product Image" />

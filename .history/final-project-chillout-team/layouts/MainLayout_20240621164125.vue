<template>
  <div id="MainLayout" class="w-full fixed z-50">
    <header id="TopMenu" class="w-full bg-[#FAFAFA] border-b md:block hidden">
    ...
    <header id="MainHeader" class="flex items-center w-full bg-white">
              ...
              <div v-if="false" class="p-1">
                ...
                >
                  <div class="flex items-center">
                    <img class="rounded-md" width="40" src="https://picsum.photos/id/9/300/300" alt="Sample Image" />
                    <div class="truncate ml-2">TESTING</div>
                  </div>
                  <div class="truncate">$ 102.99</div>
                </NuxtLink>
              </div>
            </div>
          </div>
...
<head>
  ...
  <meta name="description" content="Shop the best products on ShoppingWebsite. Discover deals on electronics, fashion, home, and more." />
</head>

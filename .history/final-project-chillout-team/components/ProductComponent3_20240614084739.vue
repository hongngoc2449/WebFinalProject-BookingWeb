<template>
  <div
    ...
    class="bg-gray-800 inline-block rounded-xl hover:shadow-[0_0_10px_3px_rgba(0,0,0,0.15)] cursor-pointer"
  >
    <NuxtLink :to="`/item/${product.id}`">
      ...
      >
        ...
        <button
          class="flex items-center justify-center text-center mx-auto mb-3 p-2 px-10 bg-[#FD374F] text-white rounded-md hover:bg-red-600"
        >
          <svg
            xmlns="http://www.w3.org/2000/svg"
            class="mr-2 h-6 w-6"

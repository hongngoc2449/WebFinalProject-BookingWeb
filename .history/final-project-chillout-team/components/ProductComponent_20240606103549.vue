<!-- bg-white inline-block rounded hover:shadow-[0_0_10px_3px_rgba(0,0,0,0.15)] cursor-pointer -->
    ...
    <NuxtLink :to="`/item/${product.id}`">
      ...
      <div id="ProductDetails">
        <span class="flex items-center justify-start gap-3 px-1 pt-1">
          <span class="text-[#FF6674] text-1.5xl">${{ priceComputed }}</span>
          <span class="text-gray-500 text-1xl text-light line-through">${{ oldPriceComputed }}</span>
        </span>
